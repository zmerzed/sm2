		...
		<div class="current-goal">
			...
			<div class="bodyFatContainer">
				<?php
					...
					echo ($age == -1 || $gender == "") ? '<a href="'.home_url( $wp->request ).'/?data=clients&edit='.$client->ID.'&editprofile="">Click here to edit</a>' : "";
				...
				<table class="skifoldTable">
					...
					<tbody>
						...
						<tr>
							...
							<td><input name="start_subscalar" ng-model="stats.start.subscalar" type="text" class="form-control" /></td>
							<td><input name="goal_subscalar" ng-model="stats.goal.subscalar" type="text" class="form-control"  /></td>
						</tr>	
						<tr>
						...
						<table class="skifoldTable">
							...
							<tbody>
								...
								<tr>
									<td>
										<input class="currentinput" type="text">
										<input style="display:none;" name="result_subscalar" ng-model="stats.result.subscalar" type="text" class="form-control" />
									</td>
								</tr>	
								<tr>
									<td>
...
$(window).ready(function () {
	...
	$('.currentinput').on('keyup',function(){
		$(this).closest('td').find('input:hidden').attr('value',$(this).val()).trigger('change').trigger('input');
	});
